...
extension SplineReducer6 {
    ...
    func getMaximumDistanceFromTestPointsToSegmentsA(isError: inout Bool) -> Float {
        ...
        if testPointCountA <= 2 {
            print("FATAL: This test requires at least 3 test points. (testPointCountA)")
            isError = true
            return Float.nan
        }
        
        if testSegmentCountA <= 2 {
            print("FATAL: This test requires at least 1 test segment. (testSegmentCountA)")
            isError = true
            return Float.nan
        }
    ...
    func addTestSegmentA(_ segment: SplineReducer6Segment) {
