...
extension SplineReducer6 {
    ...
    func getMaximumDistanceFromTestPointsToSegmentsB(isError: inout Bool) -> Float {
        ...
        if testPointCountB <= 2 {
            print("FATAL: This test requires at least 3 test points. (testPointCountB)")
            isError = true
            return Float.nan
        }
        
        if testSegmentCountB <= 2 {
            print("FATAL: This test requires at least 1 test segment. (testSegmentCountB)")
            isError = true
            return Float.nan
        }
    ...
    func addTestSegmentB(_ segment: SplineReducer6Segment) {
