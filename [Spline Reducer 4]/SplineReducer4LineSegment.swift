//
//  SplineReducer4LineSegment.swift
//  Jiggle3
//
...
class SplineReducer4Segment: PrecomputedLineSegment {
...
extension SplineReducer4Segment: CustomStringConvertible {
    var description: String {
        return "SplineReducer4Segment[\(p1.description), \(p2.description), n: \(normalX) \(normalY), d: \(directionX) \(directionY), l: \(length)]"
