//
//  SplineReducer5+AddDeleteZipperPouches.swift
//  Jiggle3
//
...
extension SplineReducer5 {
    ...
    func removeZipperPouch(_ zipperPouch: SplineReducer5ZipperPouch) {
    ...
    func addZipperPouch(_ zipperPouch: SplineReducer5ZipperPouch) {
    ...
    func purgeZipperPouches() {
        for zipperPouchIndex in 0..<zipperPouchCount {
            ...
            SplineReducer5PartsFactory.shared.depositZipperPouch(zipperPouch)
        }
        zipperPouchCount = 0
    }
