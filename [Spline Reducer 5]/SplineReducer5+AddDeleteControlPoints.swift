//
//  SplineReducer5+AddDeleteControlPoints.swift
//  Jiggle3
//
...
extension SplineReducer5 {
    ...
    func removeControlPoint(_ controlPoint: SplineReducer5ControlPoint) {
    ...
    func addControlPoint(_ controlPoint: SplineReducer5ControlPoint) {
    ...
    func purgeControlPoints() {
        for controlPointIndex in 0..<controlPointCount {
            ...
            SplineReducer5PartsFactory.shared.depositControlPoint(controlPoint)
        }
        controlPointCount = 0
    }
