//
//  SplineReducer3+AddDeleteZipperPouches.swift
//  Jiggle3
//
...
extension SplineReducer3 {
    ...
    func removeZipperPouch(_ zipperPouch: SplineReducer3ZipperPouch) {
    ...
    func addZipperPouch(_ zipperPouch: SplineReducer3ZipperPouch) {
    ...
    func purgeZipperPouches() {
        for zipperPouchIndex in 0..<zipperPouchCount {
            ...
            SplineReducer3PartsFactory.shared.depositZipperPouch(zipperPouch)
        }
        zipperPouchCount = 0
    }
